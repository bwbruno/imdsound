...
<html>
<head>
<title>IMDSound</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="IMDsound" />
									...
									<!-- //search-scripts -->
											 <!---->
											  <div class="col-md-4 player">
												...
												<!--audio-->
													<link rel="stylesheet" type="text/css" media="all" href="<?= __DIR__ ?>/css/audio.css">
		...
		<!-- //header-ends -->
			<div id="page-wrapper">
				...
				<!--//End-banner-->
					<!--albums-->
					<!-- pop-up-box --> 
							<link href="<?= __DIR__ ?>/css/popuo-box.css" rel="stylesheet" type="text/css" media="all">
				...
				<link href="<?= __DIR__ ?>/css/jplayer.blue.monday.min.css" rel="stylesheet" type="text/css">
